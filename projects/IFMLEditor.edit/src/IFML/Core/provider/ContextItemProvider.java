...
/**
 * This is the item provider adapter for a {@link IFML.Core.Context} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContextItemProvider extends ElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.Literals.CONTEXT__CONTEXT_DIMENSIONS);
			childrenFeatures.add(CorePackage.Literals.CONTEXT__CONTEXT_VARIABLES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.CONTEXT__CONTEXT_DIMENSIONS,
				 CoreFactory.eINSTANCE.createContextDimension()));

		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.CONTEXT__CONTEXT_DIMENSIONS,
				 ExtensionsFactory.eINSTANCE.createPosition()));

		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.CONTEXT__CONTEXT_DIMENSIONS,
				 ExtensionsFactory.eINSTANCE.createUserRole()));

		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.CONTEXT__CONTEXT_DIMENSIONS,
				 ExtensionsFactory.eINSTANCE.createDevice()));
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.CONTEXT__CONTEXT_VARIABLES,
				 CoreFactory.eINSTANCE.createSimpleContextVariable()));
