...
/**
 * This is the item provider adapter for a {@link IFML.Core.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider extends InteractionFlowElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_activationExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_activationExpression_feature", "_UI_Event_type"),
				 CorePackage.Literals.EVENT__ACTIVATION_EXPRESSION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.EVENT__INTERACTION_FLOW_EXPRESSION,
