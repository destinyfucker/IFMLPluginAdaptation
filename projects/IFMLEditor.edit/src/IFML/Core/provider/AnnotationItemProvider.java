...
/**
 * This is the item provider adapter for a {@link IFML.Core.Annotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CorePackage.Literals.ANNOTATION__TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Annotation)object).getText();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Annotation.class)) {
			case CorePackage.ANNOTATION__TEXT:
