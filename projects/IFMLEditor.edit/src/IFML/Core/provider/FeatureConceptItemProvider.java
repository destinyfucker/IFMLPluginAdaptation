...
/**
 * This is the item provider adapter for a {@link IFML.Core.FeatureConcept} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureConceptItemProvider extends DomainElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_FeatureConcept_visualizationAttribute_feature", "_UI_FeatureConcept_type"),
				 CorePackage.Literals.FEATURE_CONCEPT__VISUALIZATION_ATTRIBUTE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_FeatureConcept_type") :
