...
/**
 * This is the item provider adapter for a {@link IFML.Core.ViewElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewElementItemProvider extends InteractionFlowElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ViewElement_activationExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ViewElement_activationExpression_feature", "_UI_ViewElement_type"),
				 CorePackage.Literals.VIEW_ELEMENT__ACTIVATION_EXPRESSION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.Literals.VIEW_ELEMENT__VIEW_ELEMENT_EVENTS);
		}
