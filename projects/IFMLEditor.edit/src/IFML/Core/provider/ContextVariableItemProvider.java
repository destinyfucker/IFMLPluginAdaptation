...
/**
 * This is the item provider adapter for a {@link IFML.Core.ContextVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContextVariableItemProvider extends NamedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ContextVariable_scope_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ContextVariable_scope_feature", "_UI_ContextVariable_type"),
				 CorePackage.Literals.CONTEXT_VARIABLE__SCOPE,
				 true,
				 false,
				 false,
