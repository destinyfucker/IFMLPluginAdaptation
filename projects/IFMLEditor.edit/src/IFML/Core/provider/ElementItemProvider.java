...
/**
 * This is the item provider adapter for a {@link IFML.Core.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ElementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CorePackage.Literals.ELEMENT__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CorePackage.Literals.ELEMENT__CONSTRAINTS);
			childrenFeatures.add(CorePackage.Literals.ELEMENT__ANNOTATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.ELEMENT__CONSTRAINTS,
		...
		newChildDescriptors.add
			(createChildParameter
				(CorePackage.Literals.ELEMENT__ANNOTATIONS,
