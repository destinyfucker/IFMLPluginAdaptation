...
import IFML.Core.provider.ConstraintItemProvider;
...
/**
 * This is the item provider adapter for a {@link IFML.Extensions.ValidationRule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValidationRuleItemProvider extends ConstraintItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((ValidationRule)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_ValidationRule_type") :
