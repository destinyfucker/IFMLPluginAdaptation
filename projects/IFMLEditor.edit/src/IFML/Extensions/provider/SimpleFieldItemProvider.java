...
/**
 * This is the item provider adapter for a {@link IFML.Extensions.SimpleField} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SimpleFieldItemProvider extends FieldItemProvider {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SimpleField"));
	}
	...
	public String getText(Object object) {
		String label = ((SimpleField)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SimpleField_type") :
			getString("_UI_SimpleField_type") + " " + label;
	}
