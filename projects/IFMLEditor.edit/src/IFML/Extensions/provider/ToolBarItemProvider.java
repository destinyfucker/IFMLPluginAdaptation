...
/**
 * This is the item provider adapter for a {@link IFML.Extensions.ToolBar} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ToolBarItemProvider extends ViewContainerItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((ToolBar)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ToolBar_type") :
			getString("_UI_ToolBar_type") + " " + label;
	}
