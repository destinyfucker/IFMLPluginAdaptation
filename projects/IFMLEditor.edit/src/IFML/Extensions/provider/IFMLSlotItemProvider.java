...
import IFML.Core.provider.ViewComponentPartItemProvider;
 ...
 * @generated
 */
public class IFMLSlotItemProvider extends ViewComponentPartItemProvider {
	/**
	 ...
	 * @generated
	 */
	public IFMLSlotItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IFMLSlot"));
	}
	...
	public String getText(Object object) {
		String label = ((IFMLSlot)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_IFMLSlot_type") :
			getString("_UI_IFMLSlot_type") + " " + label;
	}
