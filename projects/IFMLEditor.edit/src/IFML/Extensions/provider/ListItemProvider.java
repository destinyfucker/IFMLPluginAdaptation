...
import IFML.Core.provider.ViewComponentItemProvider;
...
/**
 * This is the item provider adapter for a {@link IFML.Extensions.List} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ListItemProvider extends ViewComponentItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ExtensionsPackage.Literals.LIST__SELECT_EVENT);
		}
	...
	public String getText(Object object) {
		String label = ((IFML.Extensions.List)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IFML.Extensions.List.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ExtensionsPackage.Literals.LIST__SELECT_EVENT,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == CorePackage.Literals.VIEW_ELEMENT__VIEW_ELEMENT_EVENTS ||
			childFeature == ExtensionsPackage.Literals.LIST__SELECT_EVENT;
