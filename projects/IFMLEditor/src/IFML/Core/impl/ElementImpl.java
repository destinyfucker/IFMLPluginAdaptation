 ...
 * </p>
 * <ul>
 *   <li>{@link IFML.Core.impl.ElementImpl#getId <em>Id</em>}</li>
 *   <li>{@link IFML.Core.impl.ElementImpl#getConstraints <em>Constraints</em>}</li>
 *   <li>{@link IFML.Core.impl.ElementImpl#getAnnotations <em>Annotations</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ElementImpl extends MinimalEObjectImpl.Container implements Element {
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ELEMENT__ID, oldId, id));
	}
